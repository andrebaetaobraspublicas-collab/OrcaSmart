...
const BUILD_ID = process.env.ORCASMART_BUILD || 'orcasmart2-20260711-orcamento-sintetico-criar-composicao-visivel';
...
function runTenantMethod(method, sql, params, cb) {
  ...
  if (method === 'run' || !bootState.sharedCatalogReady || !fs.existsSync(SHARED_CATALOG_DB_PATH)) {
    return execute();
  }
