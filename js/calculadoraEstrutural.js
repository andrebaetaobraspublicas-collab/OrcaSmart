...
(function () {
  const VERSION = '20260712-estrutural-orcamento-v3';
  ...
  Router.register('calculadora-estrutural', function () {
    renderEmbeddedCalculator('embedded/calculadora-estrutural.html', 'Calculadora Estrutural');
  });
})();
